...
- **CI Validation (`.github/workflows/ci.yml`)**: Runs on every push and pull request to `main` and `develop`, verifying unit tests (`./gradlew test`) and Compose Desktop packaging.
